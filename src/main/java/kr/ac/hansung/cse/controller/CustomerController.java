...
public class CustomerController {
	...
	//여기서 생성되는 req의 body가 json 포맷이다. 라는것. json으로 넘겨준다 하는것. 
	//클라이언트도 json 처리하는게 잇어야 하는데 accept라는 헤더가 잇는데 거기에도 json이 잇어야 이게 수행됨
	...
	public ResponseEntity<List<Customer>>  getAll() {
		...
		Iterable<Customer> customers = repository.findAll();//crud Interface에 잇는것
